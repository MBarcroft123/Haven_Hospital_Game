...
var spd = min(3, point_distance(x, y, targetX, targetY));
}
else{
...
//calculates the speed based on distance from object, also taking into account a max speed (2 in this case)
var spd = min(3, point_distance(x, y, instance_find(follow_node,following_node).x, instance_find(follow_node,following_node).y));
}
